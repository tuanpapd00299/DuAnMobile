...
import tuan.Adapter.Giadinh_adapter;
...
public class GiaDinh_child extends Activity {
	ListView lv;
	Giadinh_adapter adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		arrList = dbHeplper.getAll(14);
		adapter = new Giadinh_adapter(getApplicationContext(), arrList);

...
import tuan.Adapter.Quocgia_adapter;
...
public class QuocGia_child extends Activity {
	ListView lv;
	Quocgia_adapter adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		arrList = dbHeplper.getAll(12);
		adapter = new Quocgia_adapter(getApplicationContext(), arrList);

...
import tuan.Adapter.Ngaygio_adapter;
...
public class NgayGio_child extends Activity {
	ListView lv;
	Ngaygio_adapter adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		arrList = dbHeplper.getAll(4);
		adapter = new Ngaygio_adapter(getApplicationContext(), arrList);

...
import tuan.Adapter.Muasam_adapter;
...
public class MuaSam_child extends Activity {
	ListView lv;
	Muasam_adapter adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		arrList = dbHeplper.getAll(9);
		adapter = new Muasam_adapter(getApplicationContext(), arrList);

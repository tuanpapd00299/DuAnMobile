...
import tuan.Adapter.Thanhpho_adapter;
...
public class ThanhPho_child extends Activity {
	ListView lv;
	Thanhpho_adapter adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		arrList = dbHeplper.getAll(11);
		adapter = new Thanhpho_adapter(getApplicationContext(), arrList);

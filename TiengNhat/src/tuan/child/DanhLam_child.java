...
import tuan.Adapter.Danhlam_adapter;
...
public class DanhLam_child extends Activity {
	ListView lv;
	Danhlam_adapter adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		arrList = dbHeplper.getAll(13);
		adapter = new Danhlam_adapter(getApplicationContext(), arrList);
